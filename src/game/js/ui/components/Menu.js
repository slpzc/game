...
GS.UIComponents.Menu.prototype = {
	...
	initTopPanel: function() {
		...
		this.btnLevelSelect = this.topPanel.addButton("Choose level");
		this.btnLevelSelect.onClick = function() { that.activePanel = that.levelSelectPanel; };


		this.btnOptions = this.topPanel.addButton("Settings");
	...
	initCreditsPanel: function() {
		...
		this.dblLabelCredits1 = this.creditsPanel.addDoubleLabel("code, \"art\"", "Alexey Chekunov");

		this.creditsPanel.addEmptyRow();

		this.dblLabelCredits23 = this.creditsPanel.addDoubleLabel("music, sound effects", "Danil Vlasov");

		this.creditsPanel.addEmptyRow();

		this.dblLabelCredits5 = this.creditsPanel.addDoubleLabel("skybox texture", "Sergey Epifanov");

		this.creditsPanel.addEmptyRow();

		this.dblLabelCredits6 = this.creditsPanel.addDoubleLabel("frameworks, technologies", "three.js");
		...
		this.dblLabelCredits8 = this.creditsPanel.addDoubleLabel("", "FL Studio");
		this.dblLabelCredits8 = this.creditsPanel.addDoubleLabel("", "Blender");
		this.dblLabelCredits8 = this.creditsPanel.addDoubleLabel("", "3DS MAX");
